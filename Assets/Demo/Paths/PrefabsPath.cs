namespace Demo.Paths
{
    ...
    {
        public static string Input() => "Prefab/InputBuilder";
        public static string IcePointerPath() => "Prefab/PF_IcePointer";
        public static string IceSpellPath() => "Prefab/PF_IceSpell";
